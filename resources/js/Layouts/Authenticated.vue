                ...
                <div class="nk-footer">
                    <div class="container-fluid">
                        <div class="nk-footer-wrap">
                            <div class="nk-footer-copyright"> &copy; 2023 Getlive.help.</div>
                        </div>
                    </div>
                </div>
                <!-- footer @e -->
...
<style scoped>
.fav {
    background: url('../../images/favicon_lightning.png');
}
</style>
<script setup>
...
import NioApp from '../../themes/dashlite-v3.1.3/js/vendors/nioapp/nioapp.min.js'
import $ from 'jquery'
...
global.baseUri = window.location.origin
global.NioApp = NioApp
global.$ = $

global.extendObj = (obj, ext) => {
